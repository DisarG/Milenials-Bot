...
description = official[0][0] == String(contact[0]) ? 'Solo temas de MilenialsBot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
lugar = official[0][0] == String(contact[0]) ? 'Uruguay' : official[1][0] == String(contact[0]) ? '' : official[2][0] == String(contact[0]) ? '' : official[3][0] == String(contact[0]) ? '' : country === '' ? lenguajeGB.smsContacto7() : country
